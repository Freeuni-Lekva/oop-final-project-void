...
public class QuizUpdateDto {
    ...
    public QuizUpdateDto(int quizId, String title, String description, long creatorId, Boolean randomize, Boolean isOnePage, Boolean immediateCorrection, Boolean practiceMode) {
        this.quizId = quizId;
        this.title = title;
